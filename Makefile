...
define Package/default-settings
  ...
  PKGARCH:=all
  DEPENDS:=+luci-base +luci-compat +luci-proto-ipv6 +kmod-ipt-nat6 +kmod-tun +kmod-nf-nathelper-extra +6in4 +odhcp6c +odhcpd-ipv6only +ip6tables +ip6tables-mod-nat +iptables-mod-nat-extra +libip6tc +openssl-util +@LUCI_LANG_zh_Hans
endef
